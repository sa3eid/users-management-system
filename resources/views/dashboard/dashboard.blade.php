...
<head>
  ...
  <link rel="stylesheet" href="{{asset('dashboard-template/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css')}}">
  <!-- iCheck -->
  ...
  <!-- summernote -->
  <link rel="stylesheet" href="{{asset('dashboard-template/plugins/summernote/summernote-bs4.css')}}">
              ...
              <div class="card-body">
                ...
                <div class="direct-chat-messages">
                  ...
                  <div class="direct-chat-msg">
                    ...
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="{{asset('dashboard-template/dist/img/user1-128x128.jpg')}}" alt="message user image">
                    <!-- /.direct-chat-img -->
                  ...
                  <div class="direct-chat-msg right">
                    ...
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="{{asset('dashboard-template/dist/img/user3-128x128.jpg')}}" alt="message user image">
                    <!-- /.direct-chat-img -->
                    <div class="direct-chat-text">
                ...
                <div class="direct-chat-contacts">
                  <ul class="contacts-list">
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="{{asset('dashboard-template/dist/img/user1-128x128.jpg')}}">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="{{asset('dashboard-template/dist/img/user7-128x128.jpg')}}">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="{{asset('dashboard-template/dist/img/user3-128x128.jpg')}}">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="{{asset('dashboard-template/dist/img/user5-128x128.jpg')}}">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="{{asset('dashboard-template/dist/img/user6-128x128.jpg')}}">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="{{asset('dashboard-template/dist/img/user8-128x128.jpg')}}">
...
<script src="{{asset('dashboard-template/dist/js/demo.js')}}"></script>
</body>
</html>
